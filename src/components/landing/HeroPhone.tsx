      ...
      <div className="absolute inset-0 bg-[#140F0D] rounded-[48px] shadow-[0_30px_60px_rgba(20,10,5,0.25),0_8px_16px_rgba(20,10,5,0.4)] overflow-visible">
        ...
        <div className="absolute inset-[6px] bg-black rounded-[42px] overflow-hidden">
          ...
          <div className="absolute inset-0 bg-[#F8FAFC] text-[#0F172A] overflow-hidden flex flex-col font-sans">
            ...
            <div className="flex-1 overflow-y-auto overflow-x-hidden noscroll pb-24 relative">
              <AnimatePresence>
                  ...
                  >
                    ...
                    <div className="flex flex-col items-center flex-1 w-full pt-6 px-4">
                      ...
                      <p className="text-[10px] text-center text-[#334155] font-medium leading-relaxed mt-3 max-w-[220px]">
                        Any café, any time. Pickup or delivery.
                      </p>
                ...
                {state === 'CAFE' && (
                  ...
                  >
                    ...
                    <div className="p-5 flex-1 space-y-2.5">
                      <h4 className="text-[12px] font-black uppercase tracking-[0.1em] text-[#64748B] mb-1.5">Must Try Drinks</h4>
                      ...
                      <motion.div
                        ...
                        className="p-2.5 bg-white rounded-[20px] flex items-center justify-between gap-2 shadow-[0_8px_24px_rgba(149,157,165,0.1)] transition-transform border border-[#F1F5F9]"
                      >
                        <div className="flex gap-2.5 items-center min-w-0">
                          <img src="https://images.unsplash.com/photo-1517701604599-bb29b565090c?q=80&w=200&auto=format&fit=crop" className="w-12 h-12 rounded-[12px] object-cover shrink-0 shadow-sm" alt="Vietnamese Iced" />
                          <div className="min-w-0">
                            <h5 className="text-[13px] font-bold tracking-tight text-[#0F172A] truncate">Vietnamese Iced</h5>
                            <p className="text-[10.5px] text-[#64748B] font-medium truncate">Sweetened condensed milk</p>
                            <span className="text-[13px] font-black text-[#0F172A] block">₹240</span>
                          </div>
                        </div>
                        {cartCount >= 1 ? (
                          <div className="relative shrink-0 flex items-center bg-white border-[1.5px] border-[#0055D4] rounded-full overflow-hidden shadow-[0_4px_12px_rgba(0,85,212,0.15)]">
                            <div className="w-8 h-8 flex items-center justify-center text-[#0055D4]">
                              <MS name="remove" size={17} />
                            </div>
                            <span className="min-w-[16px] text-center text-[13px] font-black text-[#0055D4]">1</span>
                            <div className="w-8 h-8 flex items-center justify-center text-[#0055D4]">
                              <MS name="add" size={17} />
                            </div>
                          </div>
                        ) : (
                          <button className="relative shrink-0 whitespace-nowrap px-4 py-2 rounded-full font-bold text-[12px] transition-all duration-300 bg-[#F1F5F9] text-[#0055D4]">
                            ADD +
                            {simulatedTap === 'item1' && (
                      ...
                      >
                        <div className="flex gap-2.5 items-center min-w-0">
                          <img src="https://images.unsplash.com/photo-1555507036-ab1f4038808a?q=80&w=200&auto=format&fit=crop" className="w-12 h-12 rounded-[12px] object-cover shrink-0 shadow-sm" alt="Almond Croissant" />
                          <div className="min-w-0">
                            <h5 className="text-[13px] font-bold tracking-tight text-[#0F172A] truncate">Almond Croissant</h5>
                            <p className="text-[10.5px] text-[#64748B] font-medium truncate">Flaky & freshly baked</p>
                            <span className="text-[13px] font-black text-[#0F172A] block">₹180</span>
                          </div>
                        </div>
                        {cartCount >= 2 ? (
                          <div className="relative shrink-0 flex items-center bg-white border-[1.5px] border-[#0055D4] rounded-full overflow-hidden shadow-[0_4px_12px_rgba(0,85,212,0.15)]">
                      ...
                      {/* Item 3 (never added — shows there's more on the menu) */}
                      <motion.div
                        initial={{ opacity: 0, y: 10 }}
                        animate={{ opacity: 1, y: 0 }}
                      ...
                      >
                        <div className="flex gap-2.5 items-center min-w-0">
                          <img src="https://images.unsplash.com/photo-1509042239860-f550ce710b93?q=80&w=200&auto=format&fit=crop" className="w-12 h-12 rounded-[12px] object-cover shrink-0 shadow-sm" alt="Cappuccino" />
                          <div className="min-w-0">
                            <h5 className="text-[13px] font-bold tracking-tight text-[#0F172A] truncate">Cappuccino</h5>
                            <p className="text-[10.5px] text-[#64748B] font-medium truncate">Rich espresso & foam</p>
                            <span className="text-[13px] font-black text-[#0F172A] block">₹190</span>
                          </div>
                        </div>
                        <button className="relative shrink-0 whitespace-nowrap px-4 py-2 rounded-full font-bold text-[12px] bg-[#F1F5F9] text-[#0055D4]">
                          ADD +
                        </button>
                      </motion.div>
                    </div>
                    ...
                    {cartCount > 0 && (
                      <div className="px-5 pb-2">
                        <motion.div
                          ...
                          className="relative w-full bg-[#0F172A] text-white py-2 px-2.5 rounded-full flex justify-between items-center cursor-pointer transition-all shadow-lg"
                        >
                          <div className="flex items-center gap-1.5 pl-1.5">
                            <span className="w-5 h-5 bg-[#0055D4] rounded-full text-white text-[10px] font-bold flex items-center justify-center">{cartCount}</span>
                            <span className="text-[11px] font-bold">{cartCount} item{cartCount > 1 ? 's' : ''} added</span>
                          </div>
                          <div className="flex items-center gap-1 pr-1.5 text-[11px] font-bold text-[#60A5FA]">
                            <span>View Cart</span>
                            <MS name="arrow_forward" size={14} />
                          </div>
                ...
                {state === 'CONFIRMATION' && (
                  ...
                  >
                    <motion.div
                      animate={{ scale: [1, 1.08, 1], boxShadow: ['0 0 0 0 rgba(0,85,212,0.25)', '0 0 0 10px rgba(0,85,212,0)', '0 0 0 0 rgba(0,85,212,0)'] }}
                      transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }}
                      className="w-14 h-14 bg-[#0055D4]/10 border-2 border-[#0055D4] rounded-full flex items-center justify-center text-[#0055D4] mb-4"
                    >
                ...
                {state === 'READY' && (
                  ...
                  >
                    <motion.div 
                      ...
                      className="w-14 h-14 bg-[#10B981] rounded-full flex items-center justify-center text-white mb-3 shadow-[0_10px_24px_-6px_rgba(16,185,129,0.45)]"
                    >
                    ...
                    <button className="w-full py-3.5 bg-[#0F172A] text-white rounded-full font-bold text-[12px] transition-transform shadow-md flex items-center justify-center gap-1.5">
            ...
            {state !== 'CAFE_WEBSITE' && (
              <div className="absolute bottom-0 inset-x-0 h-[84px] bg-[rgba(255,255,255,0.95)] border-t border-[rgba(235,228,216,0.5)] flex items-start justify-around pt-3.5 px-3 z-40 pb-5 shadow-[0_-4px_12px_rgba(15,23,42,0.06)]">
                {[
