...
export default function ProfilePage() {
  ...
  return (
    <div className="gb-shell">
      ...
      {/* gold membership */}
      <div style={{ margin: '16px 16px 0', borderRadius: 20, padding: 18, background: 'linear-gradient(120deg,#3A2A22 0%,#7A5A2E 55%,#C79A3A 130%)', color: '#fff', position: 'relative', overflow: 'hidden' }}>
