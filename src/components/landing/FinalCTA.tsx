      ...
      <div className="w-full max-w-[1500px] mx-auto bg-[#E6E2D9] rounded-[24px] sm:rounded-[32px] md:rounded-[40px] border-[3px] border-[#0A0A0D]/10 relative overflow-hidden flex flex-col md:flex-row shadow-[0_20px_60px_-15px_rgba(0,0,0,0.15)] min-h-[460px] md:min-h-[500px] lg:min-h-[540px]">
        ...
        <div className="w-full md:w-[40%] lg:w-[37%] relative flex justify-center md:justify-end items-end md:items-end pt-8 pb-0 md:py-0 px-4 sm:px-12 md:px-0 md:pr-12 lg:pr-20 z-20 pointer-events-none">
            ...
            <motion.div 
              ...
              className="relative w-[280px] sm:w-[320px] md:w-[300px] lg:w-[340px] transform-style-3d origin-center translate-y-0 sm:translate-y-4 md:translate-y-32 lg:translate-y-48"
            >
