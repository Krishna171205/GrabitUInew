    ...
    <div className="bg-background text-on-background font-body selection:bg-primary-container selection:text-on-primary-container">
      ...
      <header className="fixed top-0 w-full z-50 bg-surface/80 backdrop-blur-xl shadow-sm">
        <nav className="flex justify-between items-center px-6 h-20 w-full max-w-7xl mx-auto">
          ...
          <Link
            href="/login"
            className="bg-primary text-white px-6 py-2.5 rounded-full font-bold transition-all duration-300 shadow-lg hover:bg-primary-dim"
            style={{ boxShadow: '0 4px 24px rgba(183,18,42,0.25)' }}
          >
            Login
          </Link>
        </nav>
      ...
      <main className="pt-20">
        ...
        <section className="relative lg:hidden min-h-[88dvh] overflow-hidden">
          ...
          >
            ...
            >
              Order Ahead.<br />
              <span style={{ color: '#db313f' }}>Skip the Queue.</span>
            </motion.h1>
            <motion.p
              variants={heroItemVariants}
            ...
            <motion.button
              ...
              style={{ boxShadow: '0 20px 40px rgba(153,0,31,0.35)' }}
            >
              Find your cafe
            </motion.button>
          </motion.div>
            ...
            <motion.div variants={heroLeftVariants}>
              ...
              <motion.div className="flex flex-col sm:flex-row gap-4" variants={heroItemVariants}>
                <button
                  ...
                  style={{ boxShadow: '0 20px 40px rgba(153,0,31,0.2)' }}
                >
                  Find your cafe
                </button>
                <button
            ...
            <motion.div className="relative" variants={heroItemVariants}>
              ...
              <motion.div
                ...
                whileHover={{
                  ...
                  scale: 1.07,
                  rotate: 0,
                  boxShadow: '0 24px 48px rgba(183,18,42,0.28)',
        ...
        <section className="bg-surface-container-low overflow-hidden">
          <ContainerScroll
            titleComponent={
              <div className="mb-6">
                <span className="inline-block px-4 py-1.5 rounded-full text-xs font-bold tracking-widest uppercase mb-4 text-white" style={{ backgroundColor: '#b7122a' }}>
                  The Experience
                </span>
          ...
          >
            ...
            <div className="w-full h-full flex flex-col bg-white rounded-xl overflow-hidden font-body select-none">
              ...
              <div className="flex gap-1 px-4 py-2 border-b border-zinc-100 overflow-x-auto">
                {['Drinks', 'Food', 'Specials', 'Desserts'].map((tab, i) => (
                  <button
                    ...
                    style={i === 0 ? { background: '#b7122a', color: '#fff' } : { background: '#f4f4f5', color: '#52525b' }}
                  >
                    {tab}
                  </button>
                ))}
                ...
                {[
                  ...
                  <div key={item.name} className="flex items-center gap-3 p-3 rounded-2xl bg-zinc-50 hover:bg-zinc-100 transition-colors">
                    ...
                    <div className="flex flex-col items-end gap-1 flex-shrink-0">
                      ...
                      <button className="w-7 h-7 rounded-full flex items-center justify-center text-white text-lg font-bold" style={{ background: '#b7122a' }}>+</button>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="px-4 py-3 border-t border-zinc-100">
                <button className="w-full py-3 rounded-full font-bold text-white text-sm" style={{ background: 'linear-gradient(135deg, #b7122a, #db313f)' }}>
        ...
        >
          <span
            ...
            style={{ color: 'rgba(0,0,0,0.22)', letterSpacing: '0.4em', fontFamily: "'Inter', sans-serif" }}
          >
            Scroll down to join
          </span>
