...
export default function PartnerPitch() {
  return (
    <section className="py-32 bg-[#F8FAFC] text-[#0F172A] relative overflow-hidden">
      <div className="max-w-[1280px] mx-auto px-6 relative z-10 flex flex-col lg:flex-row items-center gap-16">
        
        {/* LEFT: Copy & CTA */}
        <div className="w-full lg:w-5/12 order-2 lg:order-1">
          <span className="inline-flex items-center gap-2 bg-[#E2E8F0]/50 text-[#64748B] text-xs font-bold tracking-widest uppercase px-4 py-1.5 rounded-full mb-6">
            For Café Owners
          </span>
          <h2 className="text-[42px] md:text-[56px] font-black tracking-tighter leading-[1.05] mb-6">
            Grow your revenue, <br />
            <span className="text-[#64748B] font-serif italic font-medium">not your queue.</span>
          </h2>
          <p className="text-[18px] text-[#64748B] font-semibold leading-relaxed mb-10 max-w-md">
            ...
            {[
              ...
              <li key={i} className="flex items-start gap-3">
                <div className="w-6 h-6 rounded-full bg-[#0F172A] flex items-center justify-center shrink-0 mt-0.5">
                  <MS name="check" size={14} color="#F8FAFC" />
                </div>
                <span className="text-[16px] font-bold text-[#0F172A]">{item}</span>
              </li>
            ))}
          </ul>

          <div className="group inline-flex items-center justify-center gap-2 bg-[#0F172A] hover:bg-[#0055D4] text-white hover:text-[#0F172A] px-8 py-4 rounded-[16px] font-bold text-[16px] cursor-pointer transition-all duration-300 shadow-md">
            Partner with us
        ...
        <div className="w-full lg:w-7/12 order-1 lg:order-2">
          <motion.div 
            ...
            className="w-full aspect-[4/3] bg-white rounded-[24px] shadow-[0_32px_64px_rgba(15, 23, 42,0.1)] border border-[#E2E8F0] overflow-hidden flex flex-col perspective-1000"
          >
            {/* Dashboard Header */}
            <div className="h-16 border-b border-gray-100 flex items-center justify-between px-6 bg-gray-50/50">
              <div className="flex items-center gap-3">
                ...
                <span className="font-bold text-[#0F172A] border-l border-gray-200 pl-3">Blue Tokai Dashboard</span>
              </div>
            ...
            <div className="p-6 flex-1 bg-[#F8FAFC]/30 flex flex-col gap-6">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
                  ...
                  <div className="text-[28px] font-black text-[#0F172A]">4m 12s</div>
                ...
                <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
                  ...
                  <div className="text-[28px] font-black text-[#0055D4]">8</div>
              ...
              <div className="flex-1 bg-white border border-gray-100 rounded-xl shadow-sm overflow-hidden flex flex-col">
                <div className="px-5 py-3 border-b border-gray-100 bg-gray-50/50 flex items-center justify-between">
                  ...
                  <span className="text-[12px] text-[#0055D4] font-bold bg-[#0055D4]/10 px-2 py-1 rounded">Auto-accepting</span>
                </div>
                <div className="p-5 flex flex-col gap-3">
                  {[
                    { id: '#4092', items: '2x Iced Americano, 1x Croissant', time: '02:45', status: 'PREPARING', color: 'bg-[#0055D4]', text: 'text-[#0F172A]' },
                    ...
                    <div key={idx} className="flex items-center justify-between p-3 rounded-lg border border-gray-100 hover:bg-gray-50 transition-colors">
                      <div className="flex items-center gap-4">
                        <div className="w-12 h-12 bg-gray-100 rounded-lg flex items-center justify-center font-bold text-[#0F172A]">{order.id}</div>
                        <div>
                          <div className="font-bold text-[#0F172A] text-[14px]">{order.items}</div>
                          <div className="text-[12px] text-gray-500 mt-0.5">Pickup at {(new Date()).toLocaleTimeString([], {hour: '2-digit', minute:'2-digit'})}</div>
                        </div>
                      </div>
                      <div className="flex items-center gap-4">
                        {order.time !== '00:00' && <span className="font-mono font-bold text-[#0F172A]">{order.time}</span>}
