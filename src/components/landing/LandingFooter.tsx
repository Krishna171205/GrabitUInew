// grabbit/src/components/landing/LandingFooter.tsx
'use client';
...
export default function LandingFooter() {
  return (
    <footer style={{ background: 'var(--gb-ink)', color: 'rgba(255,255,255,.7)', padding: '48px 22px' }}>
      ...
      <div style={{ maxWidth: 1120, margin: '24px auto 0', fontSize: 12.5, color: 'rgba(255,255,255,.45)' }}>© 2026 Grabbit. Now in Delhi. Grabbit is a product of Unified Nexgrade Private Limited.</div>
    </footer>
  );
}
